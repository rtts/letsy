...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_nopassword_logincode', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='login_codes', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'django_nopassword.logincode': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'login_codes'", 'to': u"orm['auth.User']"})
        }
    }
